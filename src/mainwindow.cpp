...
void MainWindow::setupTable()
{
    ...
    // отключаем встроенную сортировку QTableWidget,
    // чтобы использовать нашу собственную логику сортировки в PhoneBook
...
void MainWindow::onSortColumn(int column)
{
    ...
    if (column == lastColumn) {
        currentOrder = (currentOrder == Qt::AscendingOrder) ?
    ...
    m_phoneBook->sortByColumn(sortColumn, currentOrder);
